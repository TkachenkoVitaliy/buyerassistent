...
public class OracleInfoUtil {
    ...
    private final static String ORDER_DATE = "Дата заказа"; //[23]it's necessary to cut off last year information
    ...
    private final static String[] oracleColumnsNamesForDTO = {
            ...
            WIDTH_COL_NAME, LENGTH_COL_NAME, ADDITIONAL_REQUIREMENTS_COL_NAME, ORDER_DATE};
